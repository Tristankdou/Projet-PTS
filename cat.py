...
class Cat(Entity):
    ...
    def draw_loterie_sprite(self, screen, x, y, size=128):
        """Dessiner le sprite du chat pour la loterie"""
        self.update_animation(0.016)  # Animation
        ...
        # Dessiner l'indicateur de rareté
        color = self.get_rarity_color()
        pygame.draw.circle(screen, color, (x + size - 10, y + 10), 8)
